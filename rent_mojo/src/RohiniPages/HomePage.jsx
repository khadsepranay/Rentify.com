        ...
        <Box>
            ...
            <Box width={{ base: '95%', sm: '95%', md: '95%', lg: '75%' }} margin={'auto'} marginTop={'50px'}>
                <SimpleGrid columns={[4, 4, 4, 6]} spacing='25px'>
                    {
                        iconsDiv.map((el) => (
                            <Box key={el.id} cursor={'pointer'} height='120px' border={'1px solid #e2eaf0'} _hover={{ background: "#fff" }} borderRadius={'10px'} _hover={{boxShadow:"rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px"}}>
