...
const homeData = [
    ...
    },
    {
      ...
      title: "Dell XPS 13 , Intel Core i5 processor , 8th Gen - ( 8 GB / 256 GB SSD / Win 10 Pro OS , 13.3 inch,Silver )",
      price: "3679/mo"
    },
    {
      id: 19,
      ...
      img: "https://www.rentomojo.com/public/images/loader/image-loader.gif",
      title: "MacBook Air Intel Core i5 processor , 5th Gen - ( 8 GB / 128 GB SSD / Mac High Sierra OS , 13.3 inch, Silver )",
      price: "1929/mo"
    },
    {
      id: 20,
      ...
      img: "https://www.rentomojo.com/public/images/loader/image-loader.gif",
      title: "HP 15 Notebook , Intel Core i3 processor , 7th Gen  - (4GB / 1TB HDD / Win 10 Home OS / 15.6 inch/ Silver )",
      price: "949/mo"
    },
    {
      id: 21,
    ...
    <div className="carousel-main">
      ...
      <div className="carousel-wrapper">
        <Box marginBottom={'5px'} marginLeft={{base: "13%", sm:"22%", md:"12%", lg:"13%"}} textAlign={'left'} color={'#313131'}>
            ...
            <Text fontSize={'22px'} fontFamily={'Muli, sans-serif'}>take these home</Text>
            <Box backgroundColor={'#dc3236'} borderRadius={'5px'}  width={'3em'} height={'2.5px'} bottom={'-12px'}></Box>
        </Box>
        <Carousel breakPoints={breakPoints} className={'rec.rec-arrow'}>
          {homeData ?.map((el) => (
            <Box key={el.id} width={'265px'} height={'370px'} display={'flex'} flexDirection={'column'} justifyContent={'center'} gap={'20px'} margin={'18px'} padding={'20px'} backgroundColor={'#fff'} boxShadow={'rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px'}>
                <Box height={'222px'} width={'222px'} >
                  <Image src={el.img} alt="carousel-img" height={'100%'} width={'100%'} />
                </Box>
                
                <Text overflow={'hidden'} fontSize={'18px'} color={'#313131'} fontFamily={'Muli,sans-serif'} textAlign={'start'}>{el.title}</Text>
