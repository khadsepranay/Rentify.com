...
function Navbar(){
    ...
    return(
        <Box sx={{padding:"15px 0px",boxSizing:"border-box",backgroundColor:"#fafafa",marginTop:"60px",padding:{xl:"15px 0px",lg:"15px 0px",md:"15px 0px",sm:"15px 60px"},display:"flex",justifyContent:{xl:"space-around",lg:"space-around",md:"space-around",sm:"space-between"},fontFamily:"'Mulish', sans-serif;",border:"1px solid #e6e6e6"}}>
