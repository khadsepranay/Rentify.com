      ...
      <Box sx={{ width: "75vw", margin: "144px auto 0px" }}>
        <Box sx={{ display: "grid", gridTemplateColumns: "1fr 4fr", gap:"70px" }}>
          ...
          <Box>
            ...
            {
              close?(<Box></Box>):(<Box sx={{width:"120px",height:"32px",backgroundColor:"#F2ECEC",color:"gray",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"10px",gap:"5px",marginBottom:"28px",boxSizing:"border-box",padding:"5px"}}>Work From Home<CloseIcon sx={{width:"20px",marginTop:"2px",cursor:"pointer"}} onClick={()=>ResetData()}/></Box>)
            }
