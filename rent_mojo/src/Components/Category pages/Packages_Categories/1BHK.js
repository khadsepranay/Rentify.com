...
//               data && data.map((el)=>{
//                 return(
//                   <Link to={`/packages/1bhk/${el.id}`} style={{textDecoration:"none"}}>
