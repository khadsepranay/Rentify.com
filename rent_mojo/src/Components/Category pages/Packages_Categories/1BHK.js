...
function OneBHK() {
  ...
  return (
    <Box sx={{ width: "100vw", height: "100%", marginTop: "90px", padding: "0px" }}>
      ...
      <Box
        sx={{
          width: { xl: "80vw", lg: "80vw", md: "85vw", sm: "95vw" },
              ...
              <Box sx={{ width: 230, marginTop: "10px" }}>
                ...
                <Box
                  sx={{
                    ...
                    width: { xl: "100%", lg: "85%", md: "75%", sm: "75%" },
                  }}
                >
                  ...
                  return (
                    ...
                    >
                      {el.name == "1 BHK" && reset ? (
                        ...
                        >
                          <Box component="img" src={el.logo} width="25%" />
                          <Box sx={{ fontSize: "12px", letterSpacing: 0.4 }}>
                            {el.name}
                          </Box>
                          <Box sx={{ fontSize: "11px" }}>{el.NOP} Packages</Box>
                        </Box>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Box>
                              <span>{value == 100 ? el.price : el.price2}</span>
                              <span>{el.desc}</span>
                            </Box>
                            <Box>
                              <Box
