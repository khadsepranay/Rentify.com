...
function Navbar({reload,setReload}){
    ...
    return(
        <Box sx={{padding:"25px 0px",boxSizing:"border-box",backgroundColor:"#fafafa",position:"relative",top:"-30px",fontWeight:600,fontSize:"15px", padding:{xl:"15px 0px",lg:"15px 0px",md:"15px 0px",sm:"15px 0px",xs:"15px 0px"},display:{lg:"flex",md:'flex',sm:'flex',xs:'none'},justifyContent:{xl:"space-around",lg:"space-around",md:"space-around",sm:"space-between"},fontFamily:"'Mulish', sans-serif;",border:"1px solid #e6e6e6"}}>
            <Box sx={{display:"flex",margin:"auto"}}>
                ...
                {
                    sub_category?<NavLink to={`/${category}/${sub_category}`} style={{textDecoration:"none",color:"#717171"}}><Box sx={{display:{xl:"block",lg:"block",md:"block",sm:"none",xs:"none"}}}>{`> ${sub_category}`}</Box></NavLink>:<Box></Box>
                }
            ...
            <Box sx={{display:"flex",gap:{xl:"45px",lg:"40px",md:"30px",sm:"20px",xs:"20px"},justifyContent:"space-between",margin:"auto"}}>
                ...
                <NavLink to="/bikes" style={{textDecoration:"none",color:`${bikesColor}`}} onClick={()=>{changeBikesColor()}}><Box>Bikes</Box></NavLink>
